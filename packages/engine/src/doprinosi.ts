...
export const doprinos = ({
   ...
   *
   * `false` ставить лише розрахунок plaća, і лише для тих внесків, які
   * роботодавець платить понад plaća.
   */
...
export const doprinosiOdGodisnjeOsnovice = (
  ...
  return {
    ...
    // тож тут обидва підсумки збігаються. Розходяться вони лише в plaća.

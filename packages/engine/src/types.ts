...
export interface Izracun {
   ...
   * `primitak`, роботодавцю найманого — плаћа разом із внесками, які він несе
   * понад неї.
   *

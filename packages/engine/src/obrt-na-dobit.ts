 ...
 *
 * Експортується, бо той самий податок за тією самою статтею платить і d.o.o.
 * Дві копії цієї функції розійшлися б тихо.
 */
 ...
 *
 * Експортується з тієї самої причини, що й `porezNaDobit`: d.o.o. платить
 * цей самий податок за цією самою статтею.
 */

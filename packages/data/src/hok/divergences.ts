...
export const divergences: readonly Divergence[] = [
  ...
  },
  {
    ...
    reason:
      "Річна стеля osnovica для діяльності поряд із наймом порахована зі середньої зарплати позаминулого року, тоді як сусідня комірка B5 у тому ж аркуші вже використовує актуальну. За čl. 186. st. 5. стеля дорівнює prosječna plaća × 0,65 × 12, тобто 15 545,40 € на 2026 рік, а не 14 024,40 €. Закон прив'язує osnovica до prosječna plaća за січень–серпень попереднього року, тож обидві комірки мають виходити з однієї величини.",
    reference: {
      ...ZAKON_O_DOPRINOSIMA,
      article: 'čl. 7. t. 39. i čl. 186. st. 5.',
      checkedOn: CHECKED_ON,
    },
  },
  {
    kind: 'formula',
    id: 'unfounded-cent-in-poduzetnicka-placa',
    // Лише у файлі чинного закону: у книзі запланованих змін HOK цей цент уже
    // прибрав. Спроба записати «обидва сценарії» завалила сторожа реєстру.
    scenarios: ['in-force-2026'],
    sheet: 'PREGLED MOGUĆNOSTI ',
    cells: ['D5'],
    formulaContains: '+0.01',
    reason:
      'Місячні внески з poduzetnička plaća пораховані як osnovica × 36,5% плюс рівно один цент. Цей цент не випливає ні з čl. 82. st. 2., яка задає osnovica, ні з čl. 81., яка задає ставки. Він протікає далі: дванадцять центів у річних внесках, звідти в dobit і в підсумок «на руки».',
    reference: {
      ...ZAKON_O_DOPRINOSIMA,
      article: 'čl. 82. st. 2.',
      checkedOn: CHECKED_ON,

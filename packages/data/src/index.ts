 ...
 *
 * Поки що містить лише фікстури калькуляторів HOK і реєстр розбіжностей з
 * ними — матеріал для голден-тестів рушія. Самі правила приходять із
 * наскрізним зрізом паушального обрту.
 */

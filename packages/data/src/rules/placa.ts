 ...
 * пільга роботодавця, що стосується цієї плаће.
 *
 ...
 * плаћу, не нараховують зовсім, тож плаћа коштує фірмі рівно на 16,5 %
...
/**
 * Зменшення **річного** податку з `čl. 46.` — ті, що стосуються плаће.
 *
...
export interface UmanjenjaGodisnjegPorezaPravila {
  /**
   * `st. 1.` — частка річного податку з плаће, яку знімають мешканцю одиниці
   * з I. skupine розвиненості або Вуковара.
   *
   * На відміну від молодіжного, рахується від **усього** податку з плаће, а
   * не лише від частини за нижчою ставкою.
   */
  readonly zaPodrucje: Sourced<Decimal>
  /**
   * `st. 3.` — частка річного податку з плаће для громадянина Хорватії, який
 ...
 * гроші, які роботодавець може дати понад плаћу без податку й без внесків.
 *

...
export const pretpostavkeNajave2027: Pretpostavke = {
  ...
  // Середньої за повний 2026 рік не існує: рік іще не скінчився, і ніхто її
  // не прогнозує — на відміну від січня–серпня, які потрібні внескам і які
  // HOK таки спрогнозував. Тому поріг `EU plava karta` у цьому сценарії не
  // показується взагалі, замість того щоб стояти на вигаданому числі.
  prosjecnaPlacaPrethodneGodine: undefined,
}

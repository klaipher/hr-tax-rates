...
export type RazlogNeprimjene =
   ...
   *
   * Числа причина не несе навмисно. Розмір добровільного внеску стоїть в
   * іншій статті, ніж сама неплатність, а `RazlogNeprimjene` має одне
   * джерело на весь запис — тож показати суму тут означало б підписати її
   * чужою статтею (ADR-0002).
   */
